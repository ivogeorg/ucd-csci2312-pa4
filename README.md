...
The output of a sample test suite run is shown in Appendix A.
...
Output of sample test suite run (note that the actual test suite might differ):

```
/Users/ivogeorg/Library/Caches/clion11/cmake/generated/705b824b/705b824b/Debug/pa5game
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  40: --- Test - Unit - Smoketest ---                                   
  42: constructor, destructor for leaf classes from Piece hierarchy     ok

  68: --- Test - Piece - Id-s, names, printing ---                      
  72: piece id-s, names, and printing                                   ok
  72: piece id-s, names, and printing                                   ok
  72: piece id-s, names, and printing                                   ok

 123: --- Test - Piece - Viability & aging ---                          
 127: app pieces start out viable                                       ok
 152: pieces age polymorphically (with every round)                     ok
 127: app pieces start out viable                                       ok
 152: pieces age polymorphically (with every round)                     ok
 127: app pieces start out viable                                       ok
 152: pieces age polymorphically (with every round)                     ok

 196: --- Test - Piece - Energy/capacity ---                            
 200: getting agent energy and resource capacities                      ok
 200: getting agent energy and resource capacities                      ok
 200: getting agent energy and resource capacities                      ok

 228: --- Test - Piece - Taking turns ---                               
 232: 3x3, manual, simple agent going for a resource                    ok
 260: 3x3, manual, simple agent moving to an empty position             ok
 288: 3x3, manual, simple agent staying in place, not attacking         ok
 316: 3x3, manual, resources don't move                                 ok
 341: 3x3, manual, default strategic agent choosing an advantage        ok
 369: 3x3, manual, hemmed in default strategic challenging a simple     ok
 404: 3x3, manual, hemmed in default strategic staying put              ok
 434: 3x3, manual, hemmed in default strategic fleeing                  ok
 464: 3x3, manual, hemmed in aggressive strategic attacking             ok
 496: 3x3, manual, strong aggressive strategic prefers to attack        ok
 528: 3x3, manual, weak aggressive strategic goes for an advantage      ok
 232: 3x3, manual, simple agent going for a resource                    ok
 260: 3x3, manual, simple agent moving to an empty position             ok
 288: 3x3, manual, simple agent staying in place, not attacking         ok
 316: 3x3, manual, resources don't move                                 ok
 ...
 568: --- Test - Piece - Interaction ---                                
 572: 3x3, manual, two agents with equal energy                         ok
 589: 3x3, manual, two agents with inequal energy                       ok
 605: 3x3, manual, a simple agent and a resource                        ok
 621: 3x3, manual, no interaction between resources                     ok
 572: 3x3, manual, two agents with equal energy                         ok
 589: 3x3, manual, two agents with inequal energy                       ok
 605: 3x3, manual, a simple agent and a resource                        ok
 621: 3x3, manual, no interaction between resources                     ok
 ...
 646: --- Test - Surroundings - Smoketest ---                           
 648: printing PieceTypes                                               ok
 665: 3x3 grid, manual, surroundings of agents                          ok
 703: 4x5 grid, manual, surroundings of agents                          ok

 768: --- Test - Action - Smoketest ---                                 
 770: printing ActionType                                               ok
 790: 3x3, manual, agent in the middle                                  ok
 811: 7x6, manual, agent in the SW corner                               ok
 832: 7x6, movement from position to position                           ok
 862: 7x6, action needed to reach one position from another             ok

 892: --- Test - Game - Smoketest ---                                   
 894: constructor, empty game, default grid size, destructor            ok
 905: constructor with dimensions                                       ok
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
...
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
Exception generated: InsufficientDimensionsEx(minWidth=3, minHeight=3, width=2, height5)
 916: insufficient dimensions (exception generated)                     ok

 937: --- Test - Game - Populate ---                                    
 940: 3x3 grid, manual population                                       ok
 959: 4x5 grid, manual population                                       ok
Exception generated: OutOfBoundsEx(maxWidth=4, maxHeight=5, width=4, height5)
Exception generated: OutOfBoundsEx(maxWidth=4, maxHeight=5, width=6, height10)
 983: 4x5 grid, manual, out of bounds (exception generated)             ok
1012: 3x3 grid, auto population                                         ok
1023: 4x5 grid, auto population                                         ok
1034: 9x9 grid, auto population                                         ok
 940: 3x3 grid, manual population                                       ok
 959: 4x5 grid, manual population                                       ok
Exception generated: OutOfBoundsEx(maxWidth=4, maxHeight=5, width=4, height5)
Exception generated: OutOfBoundsEx(maxWidth=4, maxHeight=5, width=6, height10)
...
1057: --- Test - Game - Print ---                                       
1061: 3x3 grid, automatic population                                    ok
1092: 7x6 grid, automatic population                                    ok
1061: 3x3 grid, automatic population                                    ok
1092: 7x6 grid, automatic population                                    ok
1061: 3x3 grid, automatic population                                    ok
1092: 7x6 grid, automatic population                                    ok
...
1132: --- Test - Game - Play ---                                        
1136: 3x3 grid, manual, game w/o resources terminates immediately       ok
1148: 3x3 grid, manual, 1 simple, 1 resource                            ok
1163: 3x3 grid, manual, 1 simple, 2 resources                           ok
1179: 3x3 grid, manual, 1 simple, 3 resources                           ok
1196: 3x3 grid, manual, 2 simple, 3 resources                           ok
1214: 3x3 grid, manual, 3 simple, 3 resources                           ok
1233: 3x3 grid, manual, 1 default strategic, 1 simple, 3 resources      ok
1252: 3x3 grid, manual, 1 aggressive strategic, 3 resources             ok
1269: 3x3 grid, manual, 1 aggressive strategic, 1 far simple, 3 res     Round 0
[     ][T900 ][F902 ]
[D904 ][     ][     ]
[     ][S901 ][F903 ]
Status: Playing...
...
Status: Over!
ok
1292: 3x3 grid, manual, 1 aggressive strategic, 1 near simple, 3 res    ok
1314: 3x3 grid, manual, 1 def, 1 aggr, 1 simple, 2 resources            Round 0
[T910 ][T912 ][F913 ]
[S911 ][     ][     ]
[     ][     ][F914 ]
Status: Playing...
